  ...
  describe 'ユーザー新規登録' do
    ...
    describe 'ユーザー新規登録' do
      context '新規登録がうまくいくとき' do
        it 'nicknameとemail、passwordとpassword_confirmation、ユーザー本名の苗字と名前、各フリガナ、生年月日、性別が存在すれば登録できる' do
      ...
      context '新規登録がうまくいかないとき' do
        ...
        it '性別が『--』だと登録できない' do
          @user.sex_id = 0
          @user.valid?
          expect(@user.errors.full_messages).to include('Sex must be greater than 0')
        end
      end
    end
  end
